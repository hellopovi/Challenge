angular.module('nordeaApp.services', [])
    .factory('applicationsService', ['$cacheFactory', function($cacheFactory) {
        ...
        var appStoreApplications = [
            ...
            {"id": 5, "name": "facebook", "type": "deletable", "price": "free", "url": "/", "installed":"false", "description": "Keeping up with friends is faster than ever.• See what friends are up to • Share updates, photos and videos • Get notified when friends like and comment on your posts."},
            ...
            {"id": 9, "name": "spotify", "type": "deletable", "price": "free", "url": "/", "installed":"false", "description": "Spotify is the best way to listen to music on mobile or tablet.Search for any track, artist or album and listen for free. Make and share playlists."},
